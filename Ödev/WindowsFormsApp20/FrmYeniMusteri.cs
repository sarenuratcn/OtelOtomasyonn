...
namespace WindowsFormsApp20
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        private void dateTimePicker2_ValueChanged(object sender, EventArgs e)
        {
            ...
            Ucret = Convert.ToInt32(label11.Text) * 5000;
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Insert Into MusteriEkle (Adi,Soyadi,Cinsiyet,Telefon,Mail,TC,OdaNo,Ucret,GirisTarihi,CikisTarihi,VipSecenekler) values('" + TxtAdi.Text+"','" + TxtSoyadi.Text + "','" + comboBox1.Text +"','"+MskTelefonNo.Text+"','"+TxtMail.Text+"','"+MskTxtTcNo.Text+"','"+TxtOdaNo.Text+"','"+TxtUcret.Text+"','"+DtpGirisTarihi.Value.ToString("yyyy.MM.dd")+"','"+DtpCikisTarihi.Value.ToString("yyyy.MM.dd")+"','"+comboBox2.Text+"')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
